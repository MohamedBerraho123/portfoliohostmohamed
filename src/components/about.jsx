    ...
    const experience = [
        {
            ...
            technologies: 'C#, ASP.NET Web API, Microservices, React Js, Wordpress, Git, GitHub, Scrum, DevOps, Clean Architecture',
            ...
            projects: [
                ...
                'Project Boking UIR(React Js, .Net Clean Architecture)'
            ]
        },
        {
